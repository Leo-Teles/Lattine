...
import imgMaquinas from "../Assets/maquinaVirtual.png"
import imgAplicacionais from "../Assets/aplicacionais.png"
import imgVirtuais from "../Assets/virtuais.png"
            ...
            <div className="conteudotodo">
                ...
                <div className="ConteudoDireita">
                    ...
                    <nav className="maquinasVirtuais" >
                        ...
                        <img src={imgMaquinas} className="imgBlocos"/>
                    ...
                    <nav className="servicosAplicacionais" >
                        ...
                        <img src={imgAplicacionais} className="imgBlocos" />
                        <Link to="tela a ser criada" className="botaoBlocos" >
                         Selecionar
                        </Link>
                    ...
                    <nav className="servicosAplicacionais" >
                        ...
                        <img src={imgVirtuais} className="imgBlocos" />
                        <Link to="tela a ser criada" className="botaoBlocos" >
                         Selecionar
                        </Link>
